...
export default function MainPage() {
  ...
  return (
    ...
    <>
      ...
      >
        바텀시트 내 컨텐츠는 여기에 작성 바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성바텀시트 내 컨텐츠는 여기에 작성
      </BottomSheet>
      {/* E: 바텀시트 컴포넌트 */}
    </>
  );
